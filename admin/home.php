...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header" style="margin-left: 6px;">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                               ...
                                               <?php
                                               $tsql = "select * from roombook where stat='Not Conform'";
                                               $tre = mysqli_query($link,$tsql);
             ...
             $rsql = "SELECT * FROM `roombook` where stat='conform'";
           ...
           <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
            <div class="panel-body">
              <?php
              $msql = "SELECT * FROM roombook where stat='Conform'";
              $mre = mysqli_query($link,$msql);
