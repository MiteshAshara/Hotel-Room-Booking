...
<body>
	...
	{
		$sql1 ="select price from room where type = '".$row['troom']."' ";
		$re1 = mysqli_query($sql1);
	...
	{
	echo '<td>'.$row[$price].'</td>'; //get items using property value
...
<header>
	...
	<address >
		...
		<p>Villingili Island, <br>Addu City 28019, <br>Maldives.</p>
		<p>(+960) 68 97 888</p>
	</address>
...
<aside>
	...
	<div>
		<p align="center">Email :-  info@shangrila.com || Web :- www.shangrila.com  || Phone :- (+960) 68 97 888 </p>
	</div>
</aside>
</body>
</html>
