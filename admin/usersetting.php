                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                         ...
                                         while($row = mysqli_fetch_array($re))
                                         {
                                           ...
                                           if($id % 2 ==0 )
                                           {
                                            ...
                                            <td><a href=save_user.php?did=".$id ." <button class='btn btn-danger'> <i class='fa fa-trash' ></i>&nbsp; Delete </button></td>
                                            </tr>";
                                            $cnt++;
                                        }
                                        else
                                        {
                                            ...
                                            <td><button class='btn btn-primary btn' data-toggle='modal' data-target='#myModal' id='btndisplaymsg' onClick='displayMessage'>
                                            Update 
                                            </button></td>
                                            <td><a href=save_user.php?did=".$id ." <button class='btn btn-danger' id='btnShowMsg' onClick='showMessage()'> <i class='fa fa-edit' ></i> Delete</button></td>
                                            </tr>";
                                            $cnt++;
