		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a  class="active-menu" href="roomdel.php"><i class="fa fa-trash"></i> Delete Room</a>
					</li>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<form name="form" method="post">
										<div class="form-group">
											...
											<select name="id"  class="form-control" required>
												...
												{
													$value = $rrow['id'];
													echo '<option value="'.$value.'">'.$value.' - '.$rrow['type'].' - '.$rrow['bedding'].'</option>';
									...
									if(isset($_POST['del']))
									{
										...
										{
											echo '<script type="text/javascript">alert("Room Deleted Successully") </script>' ;
